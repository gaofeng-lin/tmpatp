 ...
 */
  ...
  handleReStart(record:any){
    ...
    if(this.checkIsErrorCase(record)){
      ...
      paramData = {test_case_id:test_case_id,is_error_case:is_error_case,test_id:test_id,type:"integration"}
    }
    else{
      const test_case_id = record.test_case_id
      const test_id = record.test_id
      paramData = {test_case_id:test_case_id,test_id:test_id,type:"integration"}
    }
  ...
  fetchApplyDownload = (test_case_id:Number) => {
    ...
    axios({
      ...
      method: "get",
      params:{test_case_id:test_case_id,type:"integration"}
    }).then((res) => {
      const data = res.data
      if(data.status == 500)
      {
  ...
  fetchCheckDownload = (record:any) => {
    ...
    axios({
      ...
      method: "get",
      params:{test_case_id:record.test_case_id,type:"integration"}
    }).then((res) => {
      const data = res.data
  ...
  fetch = () => {
    ...
    axios({
      url: "/api/searchIntegrationCaseInfo",
      method: "get",
